...
```
Добавленные словари доступны только во время запуска кода, основной словарь не меняется.
...
Был выбран последний алгоритм, так как он более академически выверен и частично снижает bais и потенциальные ошибки в НКРЯ. Остальные методики не были использованы в основном коде.
...
- Развивать интерфейс: сделать возможность исправления словарей через интерфейс, для редких слов выводить из книг примеры использования и т.д.
